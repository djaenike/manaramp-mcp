/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6bf63a919e2d619decad23a33360559)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	GAME_ROOM: DurableObjectNamespace /* GameRoom */;
	LOBBY: DurableObjectNamespace /* LobbyRegistry */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.svelte-kit/cloudflare/_worker");
		durableNamespaces: "GameRoom" | "LobbyRegistry";
	}
