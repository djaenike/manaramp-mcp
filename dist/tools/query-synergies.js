...
const querySynergiesTool = {
  ...
  description: "Look up EDHREC-derived recommended cards for a specific commander (synergy % and inclusion % per recommended card) -- use this while researching or assembling a decklist around a commander, before or instead of running the full optimize_deck analysis. Throws a clear error if the commander hasn't been ingested yet or its recommendations haven't synced -- that's a real 'not available yet' case, not a sign the commander name is wrong.",
  inputSchema,
