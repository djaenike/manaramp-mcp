/**
 * sub-tools/edhrec/recommendations.js
...
async function getCommanderRecommendations(commander_name) {
...
async function getCardSynergies(card_name) {
...
async function getAverageDecklist(commander_name) {
  const slug = slugify(commander_name);
